        ...
        if (this.hass!.config.state === STATE_NOT_RUNNING) {
          showToast(this, {
            message:
              ...
              "NRJHub is starting, not everything will be available until it is finished.",
            duration: -1,
            dismissable: false,
            action: {
              text:
          ...
          ({ showAlertDialog }) => {
            showAlertDialog(this, {
              ...
              text:
                ...
                "NRJHub is running in safe mode, custom integrations and modules are not available. Restart NRJHub to exit safe mode.",
            });
          }
        );
      }
