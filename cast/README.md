...
NRJHub Cast is made up of two separate applications:

- Chromecast receiver application that can connect to NRJHub and display relevant information.
- Launcher website that allows users to authorize with their NRJHub installation and launch the receiver app on their Chromecast.
...
If your work involves interaction with the Cast parts from the normal NRJHub UI, you will need to have that development script running too (`script/develop`).

### Developing the cast demo

The cast demo is triggered from the NRJHub demo. To work on that, you will also need to run the development script for the demo (`script/develop_demo`).
