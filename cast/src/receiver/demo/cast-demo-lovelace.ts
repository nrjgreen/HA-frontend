        ...
        cards: [
          {
            type: "markdown",
            title: "NRJHub Cast",
            content: `With NRJHub you can easily create interfaces (just like this one) which can be shown on Chromecast devices connected to TVs or Google Assistant devices with a screen.${
              touchSupported
                ? "\n\nYou are able to interact with this demo using the touch screen."
                : "\n\nOn a Google Nest Hub you are able to interact with NRJHub Cast via the touch screen."
            }`,
          },
          {
